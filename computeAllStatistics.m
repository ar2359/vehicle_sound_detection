...
%[x, fs] = audioread(fileName); -------**************Remove comment AND DELETE THE NEXT LINE*************** 
x=fileName;
fs=44100;
...
% C = SpectralCentroid(x, win*fs, step*fs, fs); -------**************Remove comment********************   
...
% FF(4) = statistic(C, 1, length(C), 'std');-------**************Remove comment AND DELETE THE NEXT LINE********************
FF(4)=0;
